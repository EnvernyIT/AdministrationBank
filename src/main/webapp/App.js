...
function loadAccountList() {
    ...
    xhttp.open("GET", "/AdministrationBank/api/account/list", true);
    xhttp.send();
}
...
function deleteAccount(accountId)
{
    ...
    xhttp.open("DELETE", "/AdministrationBank/api/account/remove", true);
    xhttp.onreadystatechange = function() {
...
function addAccount() {
    ...
    xmlhttp.open("POST", "/AdministrationBank/api/account/add", true);
