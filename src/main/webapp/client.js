...
function loadClientList() {
    ...
    xhttp.open("GET", "/AdministrationBank/api/client/list", true);
    xhttp.send();
}
...
function deleteClient(clientId)
{
    ...
    xhttp.open("DELETE", "/AdministrationBank/api/client/remove", true);
    xhttp.onreadystatechange = function() {
...
function addClient() {
    ...
    xmlhttp.open("POST", "/AdministrationBank/api/client/add", true);
...
function updateClient()
{
    ...
    var xmlhttp = new XMLHttpRequest();
    xmlhttp.open("PUT", "/AdministrationBank/api/client/update", true);
    xmlhttp.onreadystatechange = function() {
...
function getClient(clientId)
{
    ...
    xhttp.open("POST", "/AdministrationBank/api/client/getClient", true);
    xhttp.setRequestHeader("Content-Type", "application/json");
